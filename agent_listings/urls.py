...
urlpatterns = [
    ...
    # ✅ Public endpoints (unauthenticated) — added as requested
    path('', views.agent_property_list, name='agent-property-list'),
    path('detail/<int:property_id>/', views.agent_property_detail, name='agent-property-detail'),
]